            ...
            .join()
        {
            ...
            if let Some(grabbing) = grabbing {
                ...
                let thing_destination_is_blocked =
                    level_utils::tile_is_blocked(thing_destination_idx as i32, &level)
                ...
                let ent_destination_is_blocked =
                    level_utils::tile_is_blocked(ent_destination_idx as i32, &level)
            ...
            if !level_utils::tile_is_blocked(ent_destination_idx as i32, &level) {
                ...
                if let Some(_) = blocks_tiles.get(entity) {
                    level.blocked[ent_idx as usize] = false;
